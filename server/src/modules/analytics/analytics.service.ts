...
export class AnalyticsService {
  ...
  async getAnalyticsOverview(
    ...
    // Build where clause with optional sellerId filter
    const where: any = {
      createdAt: {
        gte: startDate,
        lte: endDate,
    ...
    const monthlyTrends = await this.getMonthlyTrends(startDate, endDate, sellerId);
  ...
  async getProductPerformance(
    ...
    if (sellerId) {
      orderItemsWhere.sellerId = sellerId;
    }
