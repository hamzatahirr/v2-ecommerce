...
import sellerReviewRoutes from "@/modules/seller-review/seller-review.routes";
...
import { allowedDomainsRoutes } from "@/modules/allowed-domains/allowed-domains.routes";
...
export const configureV1Routes = (io: SocketIOServer) => {
  ...
  router.use("/allowed-domains", allowedDomainsRoutes);
